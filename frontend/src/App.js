                ...
                {currentPair.item1.poster ? (
                  <>
                    <img 
                      ...
                      onLoad={() => console.log('Item1 poster loaded:', currentPair.item1.poster)}
                      onError={() => console.log('Item1 poster failed:', currentPair.item1.poster)}
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-60"></div>
                    <button
                      onClick={(e) => {
                ...
                {currentPair.item2.poster ? (
                  <>
                    <img 
                      ...
                      className="w-full h-48 md:h-80 object-cover"
                      onLoad={() => console.log('Item2 poster loaded:', currentPair.item2.poster)}
                      onError={() => console.log('Item2 poster failed:', currentPair.item2.poster)}
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-60"></div>
                    <button
                      onClick={(e) => {
